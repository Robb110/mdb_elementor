...
class TitleWithContentLogo extends Widget_Base
{

    public function get_name()
    {
        return 'title_with_content_logo';
    }

    public function get_title()
    {
        return __('Content with logo on top');
    }
...
?>
        ...
        <!-- Card -->
            ...
            <!-- Card content -->
            <div class="text-center container title-with-content-logo">
                <div class="logo">
                    <img <?php echo $this->get_render_attribute_string('logo') ?>  alt="">
                </div>
                <!-- Title -->
